...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create($prefix.'sales_invoice_items', function (Blueprint $table) use ($prefix) {
            $table->id();
            ...
            $table->foreignId('income_account_id')->nullable()->constrained($prefix.'accounts')->nullOnDelete();
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists($prefix.'sales_invoice_items');
    }
};
