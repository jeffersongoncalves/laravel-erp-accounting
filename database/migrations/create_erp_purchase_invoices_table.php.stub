...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create($prefix.'purchase_invoices', function (Blueprint $table) use ($prefix) {
            $table->id();
            ...
            $table->foreignId('credit_to_id')->constrained($prefix.'accounts')->cascadeOnDelete();
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists($prefix.'purchase_invoices');
    }
};
